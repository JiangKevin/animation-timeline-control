...
var Timeline = /*#__PURE__*/function (_TimelineEventsEmitte) {
  ...
  function Timeline() {
    ...
    timeline_defineProperty(timeline_assertThisInitialized(_this), "_generateContainers", function (id) {
      ...
      _this._scrollContainer.id = 'timeline-scroll-container';
      _this._scrollContent.id = 'timeline-container';
      _this._canvas.id = 'timeline_canvas';
      ...
      _this._scrollContainer.style.cssText = 'overflow: hidden;' + 'position: absolute;' + 'width:  100%;' + 'height:  100%;';
      _this._scrollContent.style.height = '100%';
      _this._scrollContent.style.width = 'calc(100% - 317px)';
